...
run "grep -o '\"attribution\":\"[^\"]*\"' /var/cache/kayak/docroot/static/reaches.geojson 2>/dev/null | head -1"
...
run "stat -c '%y  %n' /var/cache/kayak/docroot/index.html /var/cache/kayak/docroot/static/reaches.geojson /var/cache/kayak/docroot/static/sparklines.json 2>/dev/null"
